...
//Complier:  g++
//File type: implementation cpp file
//================================================================
...
void BST::DeleteVertex(elem_t E)
{
  ...
  if((E == Root->Elem) && (Root->Left == NULL))// if what you want to delete is the root with one child 
   {  //change the root to the child and return - this could
     Vertex* temp;//be the left or the right child 
     temp = Root;
     Root = Root->Right;
     delete temp;
     return;
  ...
  else if((E == Root->Elem) && (Root->Right == NULL)) //deleting the root and one child (right side)
    {
      Vertex* temp;// creates a temp node to delete
      temp = Root;
      Root = Root->Left;
      delete temp;
      return;
  ...
  while (V != NULL)
	...
	{  cout << "...removing " << V->Elem << endl;
      ...
      else//nothing to do in this statement, wrote this to be organized
	{
	}
...
void BST::remove(Vertex *V, Vertex *P)
{
  ...
  //********************************************************************************
	...
	if(P->Left == V)//Parent points to the left  
	  {
	    Vertex *temp;
	    temp = V;
	    P->Left = V->Left;
	...
	else//Parent points to the right
	  {
	    Vertex *temp;
	    temp = V;
	    P->Right = V->Left;
